...
ยินดีต้อนรับสู่ Repository เว็บไซต์พอร์ตโฟลิโอของ **กอบกิจ โกษาพันธุ์ (เอิร์ธ)** โปรเจกต์นี้คือ **"Web Portfolio"** ที่ผมพัฒนาขึ้นมาเอง เพื่อใช้เป็นพื้นที่จัดแสดงผลงาน (Showcase), ทักษะความสามารถ (Skills), และเรซูเม่ (Resume) สำหรับการสมัครฝึกงานและการทำงานในอุตสาหกรรมเทคโนโลยี
...
- **📑 Certificates:** สไลด์นำเสนอผลงาน (ฝังระบบ Canva) และใบรับรองทักษะภาษาอังกฤษ (EFSET C1 / SPUTEP C1)
